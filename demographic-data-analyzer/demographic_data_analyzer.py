...
def calculate_demographic_data(print_data=True):
    ...
    rich_percentage = (num_min_workers['salary']=='>50K').value_counts(normalize=True)[True] * 100

    # What country has the highest percentage of people that earn >50K?
    # Calculate the number of people from each country who earn more than 50K
